     ...
     <div class="row" align="center">
         <div class="pagination" >
             ...
             if ($current_page > 1 && $total_page > 1){
                 echo '<li><a href="index.php?index=7&page='.($current_page-1).'">Prev</a> </li> ';
             }
             for ($i = 1; $i <= $total_page; $i++){
                 if ($i == $current_page){
                     ...
                     echo '<li><a href="index.php?index=7&page='.$i.'">'.$i.'</a> </li> ';
                 }
             }
             if ($current_page < $total_page && $total_page > 1){
                 echo '<li><a href="index.php?index=7&page='.($current_page+1).'">Next</a> </li> ';
             }
             echo "</ul>";
             ?>
         </div>
