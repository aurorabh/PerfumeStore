...
$sl_sanpham = "select * from sanpham where idSP != 1";
...
<?php
$result = mysqli_query($conn, 'select count(idSP) as total from sanpham where idSP != 1');
            ...
            <div class="col-md-3 col-sm-6 col-xs-6" style="margin-bottom:10px">
                ...
                <div class="item">
                    ...
                    <div class="prod-box">
                        ...
                        <a style="color: #0e86c1;" href="MoTa.php?idSP=<?php echo $r['idSP'];?>" onclick="BuyNow(1379)" class="btn btn-default buyproduct"><strong>Mua hàng</strong></a>
                    </div>
                </div>
            </div>
    ...
    <div class="row" align="center">
        <div class="pagination" >
            ...
            if ($current_page > 1 && $total_page > 1){
                echo '<li><a href="index.php?index=1&page='.($current_page-1).'">Prev</a> </li> ';
            }
            for ($i = 1; $i <= $total_page; $i++){
                if ($i == $current_page){
                    ...
                    echo '<li><a href="index.php?index=1&page='.$i.'">'.$i.'</a> </li> ';
                }
            }
            if ($current_page < $total_page && $total_page > 1){
                echo '<li><a href="index.php?index=1&page='.($current_page+1).'">Next</a> </li> ';
            }
            echo "</ul>";
            ?>
        </div>
